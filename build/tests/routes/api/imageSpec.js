...
var image_1 = require("../../../routes/api/image");
var request = supertest_1.default(index_1.default);
describe('testing api/image endpoints', function () {
    it('gets the api/image endpoint with the correct input', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it('returns 400 bad request if invalid filename', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?filename=asmdkasda&width=200&height=200')];
                case 1:
                    response = _a.sent();
    ...
    it('returns 400 bad request if missing height', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?filename=fjord&width=200')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(400);
                    return [2 /*return*/];
